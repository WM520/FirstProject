...
@interface LoversSpaceViewController () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
- (void)loadData {
    NSString *strURL = [NSString stringWithFormat:self.URL,_page];
