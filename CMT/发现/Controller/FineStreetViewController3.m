...
@interface FineStreetViewController3 () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
@implementation FineStreetViewController3
...
- (void)loadData {
    NSString *strURL = [NSString stringWithFormat:KJingPinXiaoJie3,_page];
