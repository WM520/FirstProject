...
@interface FineStreetViewController1 () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
@implementation FineStreetViewController1
...
- (void)loadData {
    NSString *strURL = [NSString stringWithFormat:KJingPinXiaoJie1,_page];
