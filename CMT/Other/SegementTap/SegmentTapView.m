...
-(instancetype)initWithFrame:(CGRect)frame withDataArray:(NSArray *)dataArray withFont:(CGFloat)font {
    ...
    if (self) {
        ...
        //默认
        self.textNomalColor = [UIColor colorWithRed:24/255.0 green:34/255.0 blue:50/255.0 alpha:1.0];
        self.textSelectedColor = [UIColor orangeColor];
//        self.lineColor = [UIColor colorWithRed:24/255.0 green:34/255.0 blue:50/255.0 alpha:1.0];
